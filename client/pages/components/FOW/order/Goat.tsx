...
function Goat() {
  ...
  const data = {
    ...
    count3,
    dish1: "Goat Rack",
    dish2: "Goat Leg Chump",
    dish3: "Goat Square Cut",
    price1: 0.15,
    price2: 0.17,
    price3: 0.23,
  }
    ...
    <div className={styles.page}>
      <div className={styles.nav}>
        ...
        <div className="w-20 h-20 rounded-full">
          <img src='/images/goatpng.png' className='w-full h-full rounded-full' />
        </div>
        <div className="">
      ...
      <div className={styles.functionality}>
        <div className={styles.items}>
          ...
          <span className="font-semibold text-gray-500 border-b-4 border-sky-500 text-sm pt-1.5">Goat</span>
          <span className={styles.item}>Lamb</span>
        </div>
        <div className={styles.products}>
          <div className={styles.left}>
            <div className={styles.box}>
              <img src="/images/goatrack.png" className='w-full h-full' />
            </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Goat Rack</span>
              <span className='font-semibold text-gray-500 text-xs'>0.15 $$</span>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/goatleg.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Goat Leg Chump</span>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/goatsqure.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Goat Square Cut</span>
              <span className='font-semibold text-gray-500 text-xs'>0.23 $$</span>
              <span className='font-semibold text-gray-500 text-xs'>Lbs</span>
            </div>
          </div>
          <div className={styles.right}>
