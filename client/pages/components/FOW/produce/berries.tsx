    ...
    <div className={styles.page}>
      <div className={styles.nav}>
        ...
        <div className="w-20 h-20 rounded-full">
          <img src='/images/berrie.png' className='w-full h-full rounded-full' />
        </div>
        <div className="">
          <span className='font-semibold'>Berry</span>
        </div>
        <div className="mr-2">
      ...
      <div className={styles.functionality}>
        <div className={styles.items}>
          ...
          <span className="font-semibold text-gray-500 border-b-4 border-sky-500 text-sm pt-1.5">Berries</span>
        ...
        <div className={styles.products}>
          <div className={styles.left}>
            <div className={styles.box}>
              <img src="/images/blueberrie.png" className='w-full h-full' />
            </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Blueberry</span>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/grape.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Grape</span>
              <span className='font-semibold text-gray-500 text-xs'>250gm - 0.10$$</span>
              <span className='font-semibold text-gray-500 text-xs'>gm/kg</span>
            </div>
          </div>
          <div className={styles.right}>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/strawberries.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Strawberrie</span>
              <span className='font-semibold text-gray-500 text-xs'>250gm - 0.23$$</span>
              <span className='font-semibold text-gray-500 text-xs'>gm/kg</span>
            </div>
          </div>
          <div className={styles.right}>
