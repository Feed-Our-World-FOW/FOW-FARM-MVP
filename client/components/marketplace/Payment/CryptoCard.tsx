...
function CryptoCard(props: any) {
  ...
  const styles = {
    ...
    btn1: `bg-green w-8/12 rounded-3xl h-8 text-2sm font-semibold`,
        ...
        <Box className={styles.box}>
          ...
          <Box className="w-full flex justify-between items-center">
            <Box>
              ...
              <span className="text-2sm ml-2 font-normal">{walletAddress.slice(0, 5)}......{walletAddress.slice(39, 42)}</span>
            </Box>
