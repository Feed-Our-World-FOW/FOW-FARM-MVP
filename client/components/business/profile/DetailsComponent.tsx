...
function DetailsComponent(props: BusinessProfileDetailsUpdateInterface) {
  ...
  const [profileDetails, setProfileDetails] = useState<BusinessProfileDetailsUpdateInterface>({
    ...
    <div className='w-full h-full flex flex-col justify-center items-center'>
      {
        ...
        <Box className="w-full flex justify-end items-center">
          <ClearIcon fontSize='small' onClick={() => setEditDetails(false)} sx={{ marginRight: '10px', marginTop: '5px' }} />
        </Box>
      }
        ...
        <Box className={styles.subInfoBox}>
          <span className='text-2sm'>{`Shipping radius(km)`}</span>
          {
            ...
            <TextField 
              ...
              onChange={(e: any) => setProfileDetails({...profileDetails, shippingRadius: Number(e.target.value)})} 
            /> :
        ...
        <Box className={styles.subInfoBox}>
          ...
          </Box>
          {
            ...
            <TextField 
              ...
              onChange={(e: any) => setProfileDetails({...profileDetails, shippingCostStandard: Number(e.target.value)})} 
            /> :
        ...
        <Box className={styles.subInfoBox}>
          ...
          </Box>
          {
            ...
            <TextField 
              ...
              onChange={(e: any) => setProfileDetails({...profileDetails, shippingTimeStandard: e.target.value})} 
            /> :
        ...
        <Box className={styles.subInfoBox}>
          ...
          </Box>
          {
            ...
            <TextField 
              ...
              onChange={(e: any) => setProfileDetails({...profileDetails, shippingCostExpress: Number(e.target.value)})} 
            /> :
        ...
        <Box className={styles.subInfoBox}>
          ...
          </Box>
          {
            ...
            <TextField 
              ...
              onChange={(e: any) => setProfileDetails({...profileDetails, shippingTimeExpress: e.target.value})} 
            /> :
        ...
        <Box className={styles.subInfoBox}>
          <span className='text-2sm'>Shipping cost / km</span>
          {
            ...
            <TextField 
              ...
              onChange={(e: any) => setProfileDetails({...profileDetails, shippingOndemandCost: Number(e.target.value)})} 
            /> :
        ...
        <Box className={styles.subInfoBox}>
          <span className='text-2sm'>Shipping time / km</span>
          {
            ...
            <TextField 
              ...
              onChange={(e: any) => setProfileDetails({...profileDetails, shippingOndemandTime: e.target.value})} 
            /> :
      ...
      <Box className="w-full h-full flex flex-col justify-center items-center">
        ...
        <Box className="w-full flex justify-end items-end">
          {
            editDetails ?
            <AddCircleOutlineOutlinedIcon fontSize='small' onClick={handleUpdate} /> :
            <ModeEditOutlineOutlinedIcon fontSize='small' onClick={() => setEditDetails(true)} />
          }
        </Box>
      </Box>
    </div>
