    ...
    <div className={styles.page}>
      <div className={styles.nav}>
        ...
        <div className="w-20 h-20 rounded-full">
          <img src='/images/lamb.png' className='w-full h-full rounded-full' />
        </div>
        <div className="">
          <span className='font-semibold'>Lamb</span>
        </div>
        <div className="mr-2">
      ...
      <div className={styles.functionality}>
        <div className={styles.items}>
          ...
          <span className="font-semibold text-gray-500 border-b-4 border-sky-500 text-sm pt-1.5">Lamb</span>
        </div>
        <div className={styles.products}>
          <div className={styles.left}>
            <div className={styles.box}>
              <img src="/images/lambleg.png" className='w-full h-full' />
            </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Lamb Leg</span>
              <span className='font-semibold text-gray-500 text-xs'>0.22 $$</span>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/lambrack.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Lamb Rack</span>
              <span className='font-semibold text-gray-500 text-xs'>0.17 $$</span>
              <span className='font-semibold text-gray-500 text-xs'>Lbs</span>
            </div>
          </div>
          <div className={styles.right}>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/lambloin.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Lamb Loin Chump</span>
              <span className='font-semibold text-gray-500 text-xs'>0.24 $$</span>
              <span className='font-semibold text-gray-500 text-xs'>Lbs</span>
            </div>
          </div>
          <div className={styles.right}>
