    ...
    <div className={styles.page}>
      <div className={styles.nav}>
        ...
        <div className="w-20 h-20 rounded-full">
          <img src='/images/nuts.png' className='w-full h-full rounded-full' />
        </div>
        <div className="">
      ...
      <div className={styles.functionality}>
        <div className={styles.items}>
          ...
          <span className="font-semibold text-gray-500 border-b-4 border-sky-500 text-sm pt-1.5">Nuts</span>
        </div>
        <div className={styles.products}>
          <div className={styles.left}>
            <div className={styles.box}>
              <img src="/images/almonds.png" className='w-full h-full' />
            </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Almonds</span>
              <span className='font-semibold text-gray-500 text-xs'>250gm - 0.21$$</span>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/nuts.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Peanuts</span>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/cashew.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Cashew Nuts</span>
              <span className='font-semibold text-gray-500 text-xs'>250gm - 0.24$$</span>
              <span className='font-semibold text-gray-500 text-xs'>gm/kg</span>
            </div>
          </div>
          <div className={styles.right}>
