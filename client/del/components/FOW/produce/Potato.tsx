    ...
    <div className={styles.page}>
      <div className={styles.nav}>
        ...
        <div className="w-20 h-20 rounded-full">
          <img src='/images/potato.png' className='w-full h-full rounded-full' />
        </div>
        <div className="">
      ...
      <div className={styles.functionality}>
        <div className={styles.items}>
          <span className="font-semibold text-gray-500 border-b-4 border-sky-500 text-sm pt-1.5">Potato</span>
          <span className={styles.item}>Berries</span>
          <span className={styles.item}>Rice</span>
          <span className={styles.item}>Nuts</span>
        </div>
        <div className={styles.products}>
          <div className={styles.left}>
            <div className={styles.box}>
              <img src="/images/whitepotato.png" className='w-full h-full' />
            </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Potato Low Sugar</span>
              <span className='font-semibold text-gray-500 text-xs'>250gm - 0.12$$</span>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/babypotato.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Baby Potato</span>
              <span className='font-semibold text-gray-500 text-xs'>250gm - 0.16$$</span>
              <span className='font-semibold text-gray-500 text-xs'>gm/kg</span>
            </div>
          </div>
          <div className={styles.right}>
        ...
        <div className={styles.left}>
          <div className={styles.box}>
            <img src="/images/sweetpotato.png" className='w-full h-full' />
          </div>
            <div className="flex flex-col h-full justify-around items-start ml-1 w-20 max-w-36">
              <span className='text-sm font-semibold'>Sweet Potato</span>
              <span className='font-semibold text-gray-500 text-xs'>250gm - 0.20$$</span>
              <span className='font-semibold text-gray-500 text-xs'>gm/kg</span>
            </div>
          </div>
          <div className={styles.right}>
